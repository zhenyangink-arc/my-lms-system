-- Publish the generated 5:2 learning scenes for every Chapter 12 module.
with target_media as (
  ...
  where textbook.slug = 'korean-level-one-smart' and chapter.chapter_number = 12
    and media.asset_key in ('chapter-12-image-02','chapter-12-image-03','chapter-12-image-09','chapter-12-image-10','chapter-12-image-11','chapter-12-image-12','chapter-12-image-13')
)
