...
begin
  ...
  [
    {"nodeCode":"mission-map","key":"orientation-check","type":"single_choice","order":1,"maxAttempts":3,"counts":true,"prompt":{"zh-CN":"周一，智秀想问敏秀上周末做了什么。哪一句最适合？","ko-KR":"월요일에 지수는 민수에게 지난 주말에 무엇을 했는지 묻고 싶어 합니다. 가장 알맞은 말은 무엇이에요?"},"instruction":{"zh-CN":"选择符合“询问过去周末经历”的一句；本题不计分。","ko-KR":"지난 주말 경험을 묻는 표현을 고르세요. 점수에는 포함되지 않습니다."},"options":["주말에 뭐 했어요?","이거는 뭐예요?","얼마예요?","어디에 있어요?"],"config":{"shuffle":true,"showScore":false},"answer":{"kind":"index","value":0},"explanation":{"correct":{"zh-CN":"주말에 뭐 했어요?直接询问过去周末活动，本题不显示分数。","ko-KR":"주말에 뭐 했어요?는 지난 주말 활동을 직접 묻고 점수는 표시하지 않습니다."},"feedback":[{"zh-CN":"先找表示“周末”的词。","ko-KR":"주말을 뜻하는 말을 먼저 찾으세요."},{"zh-CN":"目标句需要同时含주말和过去问法뭐 했어요?。","ko-KR":"주말과 과거 질문 뭐 했어요?가 함께 필요합니다."},{"zh-CN":"正确答案是주말에 뭐 했어요?。","ko-KR":"정답은 주말에 뭐 했어요?입니다."}]}},
    {"nodeCode":"weekend-words","key":"vocabulary-check","type":"single_choice","order":1,"maxAttempts":3,"counts":true,"prompt":{"zh-CN":"在주말에 친구를 만났어요.中，주말是什么意思？","ko-KR":"주말에 친구를 만났어요.에서 주말은 무슨 뜻이에요?"},"instruction":{"zh-CN":"选择词义，再朗读整句一次并勾选确认。","ko-KR":"뜻을 고른 뒤 문장 전체를 읽고 확인하세요."},"options":["周末","星期一","上午","电影"],"config":{"shuffle":true,"audioStatus":"pending","readAloudConfirmation":{"type":"checkbox","label":"已朗读整句","required":true}},"answer":{"kind":"index_confirmation","value":0},"explanation":{"correct":{"zh-CN":"주말是“周末”；整句表示“周末见了朋友”。","ko-KR":"주말은 한 주의 끝이며 문장은 주말에 친구를 만났다는 뜻입니다."},"feedback":[{"zh-CN":"看주말后的时间助词에。","ko-KR":"주말 뒤의 시간 조사 에를 보세요."},{"zh-CN":"它指一周末尾的休息日。","ko-KR":"한 주 끝의 쉬는 날을 뜻합니다."},{"zh-CN":"正确答案是“周末”。","ko-KR":"정답은 주말입니다."}]}},
    ...
    {"nodeCode":"can-do-check","key":"review-multiple","type":"multiple_choice","order":1,"maxAttempts":3,"counts":true,"prompt":{"zh-CN":"选择所有能直接帮助讲述过去周末经历的表达。","ko-KR":"지난 주말 경험을 이야기할 때 직접 사용할 수 있는 표현을 모두 고르세요."},"instruction":{"zh-CN":"正确项全部选中且不多选才算完成。","ko-KR":"맞는 표현을 모두 고르고 틀린 표현은 고르지 마세요."},"options":["토요일에 친구를 만났어요.","밥을 먹고 영화를 봤어요.","정말 재미있었어요.","연필 주세요."],"config":{"selection":"multiple","shuffle":true},"answer":{"kind":"indices","value":[0,1,2]},"explanation":{"correct":{"zh-CN":"A说明时间动作，B连接动作，C表达过去感受；D是物品请求。","ko-KR":"A는 시간과 동작, B는 동작 연결, C는 과거 느낌이며 D는 물건 요청입니다."},"feedback":[{"zh-CN":"按时间动作、动作连接和感受检查。","ko-KR":"시간과 동작, 연결과 느낌을 확인하세요."},{"zh-CN":"有一句属于物品请求。","ko-KR":"한 문장은 물건 요청입니다."},{"zh-CN":"正确集合是A、B、C。","ko-KR":"정답은 A, B, C입니다."}]}},
