...
begin
  ...
  [
    ...
    {"nodeCode":"can-do-check","key":"review-multiple","type":"multiple_choice","order":1,"maxAttempts":3,"counts":true,"prompt":{"zh-CN":"选择所有能直接完成校园位置向导的表达。","ko-KR":"학교 위치 안내를 직접 완성하는 표현을 모두 고르세요."},"instruction":{"zh-CN":"正确项全部选中且不多选才算完成。","ko-KR":"맞는 표현을 모두 고르고 틀린 표현은 고르지 마세요."},"options":["화장실은 일층에 있어요.","도서관에 가요.","사무실 옆에 있어요.","공책하고 연필 주세요."],"config":{"selection":"multiple","shuffle":true},"answer":{"kind":"indices","value":[0,1,2]},"explanation":{"correct":{"zh-CN":"A说明位置，B说明目的地，C说明方位；D是物品请求。","ko-KR":"A는 위치, B는 목적지, C는 방향이며 D는 물건 요청입니다."},"feedback":[{"zh-CN":"按位置、目的地、方位检查。","ko-KR":"위치, 목적지와 방향을 확인하세요."},{"zh-CN":"有一句属于物品请求。","ko-KR":"한 문장은 물건 요청입니다."},{"zh-CN":"正确集合是A、B、C。","ko-KR":"정답은 A, B, C입니다."}]}},
