-- Publish the generated 5:2 learning scenes for every Chapter 10 module.
with target_media as (
  ...
  where textbook.slug = 'korean-level-one-smart'
    and chapter.chapter_number = 10
    and media.asset_key in ('chapter-10-image-02','chapter-10-image-03','chapter-10-image-08','chapter-10-image-09','chapter-10-image-10','chapter-10-image-11','chapter-10-image-12')
)
