...
-- Converted from the read-only UPLY BOOK chapter-seven master.
...
begin
  ...
  if version_uuid is null then
    raise exception 'Cannot convert chapter 07: korean-level-one-smart version was not found';
  end if;
  ...
  if lesson_uuid is null then
    raise exception 'Cannot convert chapter 07: korean-beginner/basic-pronunciation lesson was not found';
  end if;

  select id into test_uuid
  from public.chapter_tests
  where slug = 'korean-level-one-07'
  limit 1;

  if test_uuid is null then
    select id into test_uuid
    from public.chapter_tests
    where lesson_id = lesson_uuid and chapter_number = 7
    limit 1;
  end if;
  ...
  if test_uuid is null then
    insert into public.chapter_tests (
      ...
      'a3400000-0000-4000-8000-000000000007'::uuid,
      lesson_uuid, 'korean-level-one-07', 'korean-level-one', 7,
      '第 07 章测试：天气怎么样？', '제07과 평가: 날씨가 어때요?',
    ...
    update public.chapter_tests set
      ...
      slug = 'korean-level-one-07',
      course_key = 'korean-level-one',
      chapter_number = 7,
      title = '第 07 章测试：天气怎么样？',
      korean_title = '제07과 평가: 날씨가 어때요?',
  ...
  where version_id = version_uuid and (chapter_number = 7 or slug = 'weather')
  order by (slug = 'weather') desc
  limit 1;
  ...
  if chapter_uuid is null then
    insert into public.digital_textbook_chapters (
      ...
      version_uuid, test_uuid, 'weather', 7,
      ...
      'UPLY BOOK 第07课 날씨가 어때요.md @ 2026-08-18 / sha256:4104c3438ebb9b4f892396002a5c91965a8a9b09f7bf504aba6c4a92b670a52c'
    ...
    update public.digital_textbook_chapters set
      ...
      source_revision = 'UPLY BOOK 第07课 날씨가 어때요.md @ 2026-08-18 / sha256:4104c3438ebb9b4f892396002a5c91965a8a9b09f7bf504aba6c4a92b670a52c',
      updated_at = now()
  ...
  for module_seed in
    ...
    [
      ...
      },
      {
        ...
        ],"coach":{"zh-CN":"词义选对并确认朗读整句才完成；22词点读、图片分量词和另说搭配为自主练习。","ko-KR":"뜻 정답과 문장 낭독 확인이 필요하며 어휘 듣기와 단위 분류는 자율 연습입니다."},"nextNode":"weather-grammar-tools"}
      },
      {
        "code":"grammar","order":3,"accent":"iris","type":"learn","minutes":17,
        "nodeCode":"weather-grammar-tools","title":{"zh-CN":"语法讲解","ko-KR":"문법 이해"},
        ...
        "content":{"lead":{"zh-CN":"先区分商品请求与动作请求，再把数量放到量词前，用形容词评价商品，最后用도追加。","ko-KR":"상품 요청과 동작 요청을 구별한 뒤 수량과 단위를 붙이고 형용사로 평가하며 도로 추가합니다."},"grammarCards":[
          {"form":"V-(으)세요","function":{"zh-CN":"礼貌请对方做动作。","ko-KR":"상대에게 동작을 공손하게 요청합니다."},"rules":["有收音且不是ㄹ的词干接으세요","无收音词干接세요","ㄹ收音脱落规则本课只要求辨认","去掉词典形다后连写"],"examples":[{"ko":"이 가방을 보세요.","zh":"请看看这个包。","audioId":"chapter-07-grammar-01-example-01","audioStatus":"pending"},{"ko":"네, 여기에서 고르세요.","zh":"好的，请从这里挑选。","audioId":"chapter-07-grammar-01-example-02","audioStatus":"pending"},{"ko":"한번 보세요.","zh":"请看一下。","audioId":"chapter-07-grammar-01-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：보다세요；应去掉다后写보세요。","ko-KR":"잘못: 보다세요. 다를 빼고 보세요라고 씁니다."},"comparison":{"zh-CN":"보세요要求做“看”的动作；우산 주세요请求得到商品。","ko-KR":"보세요는 보는 동작 요청이고 우산 주세요는 상품 요청입니다."},"source":{"zh-CN":"母本§5.1；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.1; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},
          {"form":"固有词数量＋量词","function":{"zh-CN":"说清买几个、几瓶，并与韩元金额区分。","ko-KR":"몇 개나 몇 병을 사는지 말하고 원 단위 금액과 구별합니다."},"rules":["量词前用한、두、세、네","顺序为商品名词＋数量＋量词","一般物品用개，瓶装商品用병","金额使用汉字词数字＋원"],"examples":[{"ko":"사과 세 개 주세요.","zh":"请给我三个苹果。","audioId":"chapter-07-grammar-02-example-01","audioStatus":"pending"},{"ko":"사과 세 개 주세요.","zh":"请给我三个苹果。","audioId":"chapter-07-grammar-02-example-02","audioStatus":"pending"},{"ko":"민지는 사과 세 개를 사요.","zh":"敏智买三个苹果。","audioId":"chapter-07-grammar-02-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：사과 삼 개；一般商品数量在개前用세。","ko-KR":"잘못: 사과 삼 개. 개 앞에서는 세를 씁니다."},"comparison":{"zh-CN":"사과 세 개是数量；삼천 원是金额。","ko-KR":"사과 세 개는 수량이고 삼천 원은 금액입니다."},"source":{"zh-CN":"母本§5.2；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.2; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},
          {"form":"N이/가 A-아/어요","function":{"zh-CN":"用形容词在句末评价商品。","ko-KR":"형용사를 문장 끝에 써서 상품을 평가합니다."},"rules":["有收音名词后用이，无收音用가","形容词变礼貌体作谓语","커요本课整词认读","形容词谓语后不再加이에요/예요"],"examples":[{"ko":"이 사과가 싸요.","zh":"这个苹果便宜。","audioId":"chapter-07-grammar-03-example-01","audioStatus":"pending"},{"ko":"사과가 싸요.","zh":"苹果便宜。","audioId":"chapter-07-grammar-03-example-02","audioStatus":"pending"},{"ko":"이 우산이 커요.","zh":"这把雨伞大。","audioId":"chapter-07-grammar-03-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：비싸요예요；비싸요已经是完整谓语。","ko-KR":"잘못: 비싸요예요. 비싸요만으로 서술어가 완성됩니다."},"comparison":{"zh-CN":"가방이 비싸요是完整句；비싼 가방属于后续定语形式。","ko-KR":"가방이 비싸요는 완전한 문장이고 비싼 가방은 뒤 과정의 관형형입니다."},"source":{"zh-CN":"母本§5.3；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.3; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},
          {"form":"N도","function":{"zh-CN":"追加商品或同类信息。","ko-KR":"상품이나 같은 종류의 정보를 더합니다."},"rules":["도直接接名词","本课中替代主格或宾格助词","必须有可理解的前项","数量可放在도之后"],"examples":[{"ko":"우유도 한 병 주세요.","zh":"牛奶也请给我一瓶。","audioId":"chapter-07-grammar-04-example-01","audioStatus":"pending"},{"ko":"바나나도 두 개 주세요.","zh":"香蕉也请给我两个。","audioId":"chapter-07-grammar-04-example-02","audioStatus":"pending"},{"ko":"우유도 한 병 사요.","zh":"牛奶也买一瓶。","audioId":"chapter-07-grammar-04-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：우유를도；追加时도直接替代를。","ko-KR":"잘못: 우유를도. 추가할 때 도가 를을 대신합니다."},"comparison":{"zh-CN":"우유 한 병 주세요是首次提出；우유도 한 병 주세요表示追加。","ko-KR":"우유 한 병 주세요는 첫 요청이고 우유도 한 병 주세요는 추가 요청입니다."},"source":{"zh-CN":"母本§5.4；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.4; 기존 전자책 쪽수는 수동 확인이 필요합니다."}}
        ],"coach":{"zh-CN":"六项填空全部正确才完成；口头规则解释和扩展变形为自主练习。","ko-KR":"여섯 빈칸을 모두 맞혀야 하며 규칙 설명과 확장 활용은 자율 연습입니다."},"nextNode":"forecast-pattern-lab"}
      },
      {
        "code":"patterns","order":4,"accent":"coral","type":"practice","minutes":11,
        "nodeCode":"forecast-pattern-lab","title":{"zh-CN":"句型操练","ko-KR":"문형 연습"},
      ...
      },
      {
        ...
        "content":{"lead":{"zh-CN":"听力从数量和单价抓总价；口语按九类信息清单完成两个角色交替的交易。","ko-KR":"듣기에서는 수량과 단가로 전체 금액을 찾고 말하기에서는 아홉 정보로 두 역할 대화를 완성합니다."},"listening":{"audioId":"chapter-07-listening-forecast","audioStatus":"pending","question":{"zh-CN":"敏智买的东西一共多少钱？","ko-KR":"민지는 모두 얼마를 내요?"}},"speakingFrame":["___이/가 얼마예요?","한 개/병에 ___원이에요.","___이/가 싸요/비싸요/커요/작아요.","___도 ___ 개/병 주세요.","모두 얼마예요?／모두 ___원이에요."],"coach":{"zh-CN":"音频真实制作并可播放后听力才可完成；口语提交只记录完成证据，不产生正确性或分数。","ko-KR":"실제 음원이 재생 가능해야 듣기를 완료할 수 있고 말하기는 정오나 점수 없이 완료 증거만 기록합니다."},"nextNode":"city-weather-card"}
      },
      {
        "code":"read_write","order":7,"accent":"iris","type":"practice","minutes":12,
        "nodeCode":"city-weather-card","title":{"zh-CN":"读写拓展","ko-KR":"읽기·쓰기"},
      ...
      },
      {
        ...
        "content":{"lead":{"zh-CN":"按词汇、语法、理解、表达和读写错因返回对应节点；自主复习展示不作为强制证据。","ko-KR":"어휘, 문법, 이해, 표현과 읽기·쓰기의 원인에 따라 해당 노드로 돌아갑니다."},"canDo":[{"ko":"상품의 단가와 전체 금액을 묻고 들을 수 있어요.","zh":"我能询问并听懂商品单价和总价。"},{"ko":"고유어 수와 개／병을 사용하여 상품 수량을 말할 수 있어요.","zh":"我能用固有词数量和개／병说商品数量。"},{"ko":"-(으)세요로 쇼핑 동작을 공손하게 요청할 수 있어요.","zh":"我能用-(으)세요礼貌请对方做购物相关动作。"},{"ko":"형용사 서술어로 상품을 평가하고 도로 상품을 추가할 수 있어요.","zh":"我能用形容词谓语评价商品，并用도追加商品。"},{"ko":"35~50초 동안 8턴 이상의 두 역할 쇼핑 대화를 할 수 있어요.","zh":"我能完成35—50秒、不少于8轮的双角色购物对话。"}],"remediation":[{"reason":"词汇","node":"weather-and-seasons"},{"reason":"语法","node":"weather-grammar-tools"},{"reason":"理解","node":"weather-before-going-out／listen-and-forecast"},{"reason":"表达","node":"listen-and-forecast"},{"reason":"读写","node":"city-weather-card"}],"chapterTest":"korean-level-one-07","coach":{"zh-CN":"综合多选答对，五项自查全部回应并记录返回节点或none后完成。","ko-KR":"종합 문제 정답과 다섯 점검 및 복습 위치 또는 none 기록이 필요합니다."}}
      }
    ] $modules$::jsonb)
  loop
  ...
  -- Replace the mechanical chapter-six scaffold above with the chapter-seven
  -- master content before any activity or media row can be observed.
  for module_seed in
    select value from jsonb_array_elements($chapter_seven_modules$
    [
      {"code":"orientation","title":{"zh-CN":"课前导航","ko-KR":"학습 안내"},"description":{"zh-CN":"确认出门前需要听清时段、变化和准备建议。","ko-KR":"외출 전에 시간대, 변화와 준비 안내를 확인합니다."},"nodeCode":"mission-map","nodeTitle":{"zh-CN":"出门前要先听懂什么？","ko-KR":"외출 전에 무엇을 먼저 들어야 할까요?"},"content":{"lead":{"zh-CN":"只知道天气不错还不能决定带什么；要听清时段、变化和准备建议。","ko-KR":"날씨가 좋다는 말만으로는 준비물을 정할 수 없어 시간대와 변화를 들어야 합니다."},"targets":[{"ko":"오늘 날씨가 어때요?","zh":"询问天气"},{"ko":"오늘은 맑고 따뜻합니다.","zh":"播报今天"},{"ko":"내일 오후에는 비가 옵니다.","zh":"播报明天"},{"ko":"우산을 준비하세요.","zh":"给出建议"}],"finalOutput":{"zh-CN":"50—70秒、7—9句的城市天气播报，包含季节、今天、时段反差、明天和准备建议。","ko-KR":"계절, 오늘, 시간대 대조, 내일과 준비 안내를 포함한 50~70초, 7~9문장의 도시 날씨 안내입니다."},"coach":{"zh-CN":"答对不计分场景诊断即完成；复述任务为自主展示。","ko-KR":"점수 없는 장면 진단 정답만 필수이며 마지막 과제 설명은 자율 활동입니다."},"nextNode":"weather-and-seasons"}},
      {"code":"vocabulary","title":{"zh-CN":"核心词汇","ko-KR":"핵심 어휘"},"description":{"zh-CN":"把22个季节、时段、天气和准备物词与搭配一起记。","ko-KR":"계절, 시간대, 날씨와 준비물 어휘 22개를 결합과 함께 익힙니다."},"nodeCode":"weather-and-seasons","nodeTitle":{"zh-CN":"把季节、时段、天气和准备物配成块","ko-KR":"계절, 시간대, 날씨와 준비물을 말덩이로 익히기"},"content":{"lead":{"zh-CN":"按看图辨认、点读原形、跟读搭配、放进时段句学习；全部音频待制作。","ko-KR":"그림 확인, 기본형 듣기, 결합 따라 읽기와 시간대 문장 순서로 익힙니다. 음원은 제작 대기 중입니다."},"vocabulary":[{"ko":"계절","zh":"季节","pos":"名词","collocation":"무슨 계절이에요?"},{"ko":"봄","zh":"春天","pos":"名词","collocation":"봄에는 따뜻해요."},{"ko":"여름","zh":"夏天","pos":"名词","collocation":"여름에는 더워요."},{"ko":"가을","zh":"秋天","pos":"名词","collocation":"가을에는 시원해요."},{"ko":"겨울","zh":"冬天","pos":"名词","collocation":"겨울에는 추워요."},{"ko":"날씨","zh":"天气","pos":"名词","collocation":"날씨가 어때요?"},{"ko":"기온","zh":"气温","pos":"名词","collocation":"낮 기온"},{"ko":"아침","zh":"早晨","pos":"名词","collocation":"아침에는 맑아요."},{"ko":"낮","zh":"白天","pos":"名词","collocation":"낮에는 더워요."},{"ko":"밤","zh":"夜晚","pos":"名词","collocation":"밤에는 시원해요."},{"ko":"맑다","zh":"晴朗","pos":"形容词","collocation":"날씨가 맑아요."},{"ko":"흐리다","zh":"阴、阴沉","pos":"形容词","collocation":"날씨가 흐려요."},{"ko":"덥다","zh":"热","pos":"形容词","collocation":"낮에는 더워요."},{"ko":"춥다","zh":"冷","pos":"形容词","collocation":"밤에는 추워요."},{"ko":"따뜻하다","zh":"温暖","pos":"形容词","collocation":"맑고 따뜻해요."},{"ko":"시원하다","zh":"凉爽","pos":"形容词","collocation":"밤에는 시원해요."},{"ko":"비","zh":"雨","pos":"名词","collocation":"비가 와요."},{"ko":"눈","zh":"雪","pos":"名词","collocation":"눈이 와요."},{"ko":"바람","zh":"风","pos":"名词","collocation":"바람이 불어요."},{"ko":"우산","zh":"雨伞","pos":"名词","collocation":"우산을 준비하세요."},{"ko":"겉옷","zh":"外套","pos":"名词","collocation":"겉옷을 가져가세요."},{"ko":"준비하다","zh":"准备","pos":"动词","collocation":"우산을 준비하세요."}],"coach":{"zh-CN":"词义选对并确认朗读整句才完成；22词点读和看图快说为自主练习。","ko-KR":"뜻 정답과 문장 낭독 확인이 필요하며 듣기와 그림 말하기는 자율 연습입니다."},"nextNode":"weather-grammar-tools"}},
      {"code":"grammar","title":{"zh-CN":"语法讲解","ko-KR":"문법 이해"},"description":{"zh-CN":"用ㅂ不规则、-지만、正式体和天气状态-고说明天气。","ko-KR":"ㅂ 불규칙, -지만, 격식체와 날씨 상태 -고로 날씨를 설명합니다."},"nodeCode":"weather-grammar-tools","nodeTitle":{"zh-CN":"把天气变化说得自然、清楚、正式","ko-KR":"날씨 변화를 자연스럽고 분명하며 격식 있게 말하기"},"content":{"lead":{"zh-CN":"先处理덥다/춥다，再区分相加与反差，最后切换正式播报体。","ko-KR":"덥다와 춥다를 활용하고 첨가와 대조를 구별한 뒤 격식체로 바꿉니다."},"grammarCards":[{"form":"ㅂ 불규칙","function":{"zh-CN":"描述冷热时自然变化덥다/춥다。","ko-KR":"더위와 추위를 자연스럽게 활용합니다."},"rules":["元音起始词尾前ㅂ脱落并加우","더우+어요缩约为더워요","辅音词尾前保留ㅂ：덥지만、춥습니다","입다、잡다等规则动词不套用"],"examples":[{"ko":"여름에는 날씨가 더워요.","zh":"夏天天气很热。","audioId":"chapter-07-grammar-01-example-01","audioStatus":"pending"},{"ko":"낮에는 더워요. 바람도 불어요.","zh":"白天很热，也会刮风。","audioId":"chapter-07-grammar-01-example-02","audioStatus":"pending"},{"ko":"낮에는 따뜻하지만 밤에는 추워요.","zh":"白天暖和，但晚上很冷。","audioId":"chapter-07-grammar-01-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：덥어요；元音词尾前应写더워요。","ko-KR":"잘못: 덥어요. 모음 어미 앞에서는 더워요입니다."},"comparison":{"zh-CN":"더워요/추워요用于日常对话；덥습니다/춥습니다用于正式播报。","ko-KR":"더워요와 추워요는 대화체, 덥습니다와 춥습니다는 격식체입니다."},"source":{"zh-CN":"母本§5.1；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.1; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},{"form":"A/V-지만","function":{"zh-CN":"连接有反差的天气信息。","ko-KR":"대조되는 날씨 정보를 연결합니다."},"rules":["词干后直接加지만","有无收音不改变-지만","ㅂ不规则词在辅音词尾前保留ㅂ","后项放更需注意的变化"],"examples":[{"ko":"낮에는 덥지만 밤에는 시원해요.","zh":"白天热，但晚上凉快。","audioId":"chapter-07-grammar-02-example-01","audioStatus":"pending"},{"ko":"밤에는 시원하지만 비가 와요.","zh":"晚上凉快，但是会下雨。","audioId":"chapter-07-grammar-02-example-02","audioStatus":"pending"},{"ko":"낮에는 덥지만 밤에는 시원합니다.","zh":"白天热，但晚上凉快。","audioId":"chapter-07-grammar-02-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：더워지만；-지만直接接덥-。","ko-KR":"잘못: 더워지만. -지만은 덥-에 직접 붙습니다."},"comparison":{"zh-CN":"-고表示相加；-지만表示反差。","ko-KR":"-고는 첨가, -지만은 대조를 나타냅니다."},"source":{"zh-CN":"母本§5.2；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.2; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},{"form":"A/V-습니다/ㅂ니다","function":{"zh-CN":"面向听众正式播报天气。","ko-KR":"청중에게 날씨를 격식 있게 안내합니다."},"rules":["无收音词干加-ㅂ니다","有收音词干加-습니다","ㄹ收音脱落后加-ㅂ니다","ㅂ不规则词在辅音词尾前保留ㅂ"],"examples":[{"ko":"오늘 서울은 맑습니다.","zh":"今天首尔晴朗。","audioId":"chapter-07-grammar-03-example-01","audioStatus":"pending"},{"ko":"내일 오전에는 흐리고 오후에는 비가 옵니다.","zh":"明天上午阴，下午有雨。","audioId":"chapter-07-grammar-03-example-02","audioStatus":"pending"},{"ko":"토요일 부산은 맑고 따뜻합니다.","zh":"星期六釜山晴朗而温暖。","audioId":"chapter-07-grammar-03-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：오습니다；无收音词干오-接-ㅂ니다写作옵니다。","ko-KR":"잘못: 오습니다. 오- 뒤에는 -ㅂ니다를 붙여 옵니다입니다."},"comparison":{"zh-CN":"비가 와요是同学间礼貌体；비가 옵니다是正式播报体。","ko-KR":"비가 와요는 대화체이고 비가 옵니다는 격식체입니다."},"source":{"zh-CN":"母本§5.3；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.3; 기존 전자책 쪽수는 수동 확인이 필요합니다."}},{"form":"A/V-고","function":{"zh-CN":"并列同一时段的两项天气。","ko-KR":"같은 시간대의 두 날씨 정보를 나열합니다."},"rules":["词干后直接加고","有无收音都不改变-고","ㅂ不规则词在辅音词尾前保留ㅂ","本课聚焦天气状态相加"],"examples":[{"ko":"오늘은 맑고 따뜻해요.","zh":"今天晴朗而温暖。","audioId":"chapter-07-grammar-04-example-01","audioStatus":"pending"},{"ko":"오전에는 흐리고 오후에는 맑아요.","zh":"上午阴，下午晴。","audioId":"chapter-07-grammar-04-example-02","audioStatus":"pending"},{"ko":"일요일 오전에는 흐리고 오후에는 비가 옵니다.","zh":"星期日上午阴，下午有雨。","audioId":"chapter-07-grammar-04-example-03","audioStatus":"pending"}],"caution":{"zh-CN":"错误：맑아고；应取词干맑-加고。","ko-KR":"잘못: 맑아고. 맑-에 고를 붙여 맑고라고 씁니다."},"comparison":{"zh-CN":"-고相加天气，-지만突出反差。","ko-KR":"-고는 날씨를 더하고 -지만은 대조를 강조합니다."},"source":{"zh-CN":"母本§5.4；旧电子书精确页码待人工核对。","ko-KR":"원고 §5.4; 기존 전자책 쪽수는 수동 확인이 필요합니다."}}],"coach":{"zh-CN":"六项填空全部正确才完成；口头规则解释与扩展变形为自主练习。","ko-KR":"여섯 빈칸을 모두 맞혀야 하며 규칙 설명과 확장 활용은 자율 연습입니다."},"nextNode":"forecast-pattern-lab"}},
      {"code":"patterns","title":{"zh-CN":"句型操练","ko-KR":"문형 연습"},"description":{"zh-CN":"把天气单句组织成有顺序的播报。","ko-KR":"날씨 문장을 순서가 있는 안내로 조직합니다."},"nodeCode":"forecast-pattern-lab","nodeTitle":{"zh-CN":"从天气单句变成有顺序的播报","ko-KR":"날씨 문장을 순서 있는 안내로 만들기"},"content":{"lead":{"zh-CN":"先练季节、并列天气和时段反差，再排列五个完整播报语块。","ko-KR":"계절, 날씨 나열과 시간대 대조를 연습한 뒤 다섯 안내 문장을 배열합니다."},"replacementSets":[["여름에는 더워요.","겨울에는 추워요.","봄에는 따뜻해요.","가을에는 시원해요."],["맑고 따뜻해요.","흐리고 시원해요.","비가 오고 바람이 불어요."],["낮에는 덥지만 밤에는 시원해요.","아침에는 흐리지만 오후에는 맑아요.","내일은 흐리지만 따뜻합니다."]],"orderItems":["낮에는 덥지만 밤에는 시원합니다.","오늘은 맑고 따뜻합니다.","우산을 준비하세요.","서울 날씨입니다.","내일 오후에는 비가 옵니다."],"personalFrames":["___에는 더워요/추워요/따뜻해요/시원해요.","오늘은 ___고 ___어요.","___에는 ___지만 ___에는 ___어요."],"coach":{"zh-CN":"五语块排序全对才完成；替换、快答和个人表达为自主练习。","ko-KR":"다섯 문장 배열 정답만 필수이며 바꿔 말하기와 개인 표현은 자율 연습입니다."},"nextNode":"weather-before-going-out"}},
      {"code":"dialogue","title":{"zh-CN":"实战对话","ko-KR":"실전 대화"},"description":{"zh-CN":"从两组对话抓住今天、明天、时段变化和准备物。","ko-KR":"두 대화에서 오늘, 내일, 시간대 변화와 준비물을 파악합니다."},"nodeCode":"weather-before-going-out","nodeTitle":{"zh-CN":"先听变化，再决定带什么","ko-KR":"변화를 듣고 준비물 정하기"},"content":{"lead":{"zh-CN":"先整段默读，待音频制作后整段听，再逐句跟读、隐藏中文和切换角色。","ko-KR":"전체를 읽고 음원 제작 후 들은 뒤 문장별로 따라 읽고 역할을 바꿉니다."},"dialogueScenes":[{"title":{"zh-CN":"周五放学前的学校大厅","ko-KR":"금요일 방과 전 학교 로비"},"people":{"zh-CN":"智敏与俊浩，同班同学","ko-KR":"지민과 준호, 같은 반 친구"},"purpose":{"zh-CN":"确认今天早晨、白天和夜间天气并决定是否带伞。","ko-KR":"오늘 아침, 낮과 밤 날씨를 확인하고 우산을 준비할지 정합니다."},"audioId":"chapter-07-dialogue-main","audioStatus":"pending","lines":[{"speaker":"지민","ko":"오늘 날씨가 어때요?","zh":"今天天气怎么样？"},{"speaker":"준호","ko":"아침에는 맑고 따뜻해요.","zh":"早上晴朗又温暖。"},{"speaker":"지민","ko":"낮에도 따뜻해요?","zh":"白天也暖和吗？"},{"speaker":"준호","ko":"아니요. 낮에는 더워요. 바람도 불어요.","zh":"不。白天很热，也会刮风。"},{"speaker":"지민","ko":"밤에는 어때요?","zh":"晚上怎么样？"},{"speaker":"준호","ko":"밤에는 시원하지만 비가 와요.","zh":"晚上凉快，但是会下雨。"},{"speaker":"지민","ko":"그럼 우산이 필요해요?","zh":"那需要雨伞吗？"},{"speaker":"준호","ko":"네, 우산을 가져가세요.","zh":"是的，请带上雨伞。"}]},{"title":{"zh-CN":"周五下午的教室窗边","ko-KR":"금요일 오후 교실 창가"},"people":{"zh-CN":"素拉与敏秀，同班同学","ko-KR":"소라와 민수, 같은 반 친구"},"purpose":{"zh-CN":"确认明天上午下午天气和昼夜温差并决定是否带外套。","ko-KR":"내일 오전과 오후 날씨, 낮과 밤 기온을 확인하고 겉옷을 준비할지 정합니다."},"audioId":"chapter-07-dialogue-alt","audioStatus":"pending","lines":[{"speaker":"소라","ko":"내일 날씨가 어때요?","zh":"明天天气怎么样？"},{"speaker":"민수","ko":"오전에는 흐리고 오후에는 맑아요.","zh":"上午阴，下午晴。"},{"speaker":"소라","ko":"기온은 어때요?","zh":"气温怎么样？"},{"speaker":"민수","ko":"낮에는 따뜻하지만 밤에는 추워요.","zh":"白天暖和，但是晚上很冷。"},{"speaker":"소라","ko":"그럼 겉옷이 필요해요?","zh":"那需要外套吗？"},{"speaker":"민수","ko":"네, 겉옷을 가져가세요.","zh":"是的，请带上外套。"}]}],"coach":{"zh-CN":"事实组合题和自然回应题都答对才完成；信息替换和双角色试录为自主练习。","ko-KR":"날씨 사실과 자연스러운 응답을 모두 맞혀야 하며 바꿔 말하기와 시험 녹음은 자율 연습입니다."},"nextNode":"listen-and-forecast"}},
      {"code":"listen_speak","title":{"zh-CN":"听说任务","ko-KR":"듣기·말하기"},"description":{"zh-CN":"听出明天下午天气，再完成一分钟城市天气播报。","ko-KR":"내일 오후 날씨를 듣고 1분 도시 날씨 안내를 합니다."},"nodeCode":"listen-and-forecast","nodeTitle":{"zh-CN":"听出明天下午，再完成一分钟播报","ko-KR":"내일 오후를 듣고 1분 안내 완성하기"},"content":{"lead":{"zh-CN":"私有听力只显示待制作音频控件和问题；脚本、答案、停顿与对象键只在服务端。","ko-KR":"듣기 원고, 정답, 쉼과 객체 키는 서버에서만 관리합니다."},"speakingTask":{"duration":"50—70秒","targetSeconds":60,"minimumSentences":7,"maximumSentences":9,"requiredInformation":["城市与季节","今天两项-고天气","一次-지만时段反差","明天正式预报","有依据的准备建议"],"formalStyle":true,"pronunciationScore":false},"coach":{"zh-CN":"音频制作并可播放后听力答对，同时提交满足时长、句数、五类信息与语体要求的录音才完成。","ko-KR":"음원이 제작되어 재생 가능하고 듣기 정답과 말하기 조건을 모두 충족해야 합니다."},"nextNode":"city-weather-card"}},
      {"code":"read_write","title":{"zh-CN":"读写拓展","ko-KR":"읽기·쓰기"},"description":{"zh-CN":"读周末天气公告，再写原创城市天气卡。","ko-KR":"주말 날씨 안내문을 읽고 새로운 도시 날씨 카드를 씁니다."},"nodeCode":"city-weather-card","nodeTitle":{"zh-CN":"读简短天气公告，写新的城市预报","ko-KR":"짧은 날씨 안내문을 읽고 새로운 도시 예보 쓰기"},"content":{"lead":{"zh-CN":"按星期和时段读取信息，让准备建议能回到正文天气依据。","ko-KR":"요일과 시간대에 따라 읽고 준비 안내가 날씨 근거와 연결되게 씁니다."},"reading":{"title":"부산 주말 날씨","lines":["토요일 부산은 맑고 따뜻합니다.","낮에는 덥지만 밤에는 시원합니다.","일요일 오전에는 흐리고 오후에는 비가 옵니다.","바람도 붑니다.","우산을 준비하세요."]},"writing":{"audience":{"zh-CN":"同班同学","ko-KR":"같은 반 친구"},"sentences":"5—6","requirements":["城市与季节特征","今天两项天气","时段反差","明天正式预报","有依据的准备建议"],"frame":"___ 날씨입니다. → ___에는 ___습니다. → 오늘은 ___고 ___습니다. → ___에는 ___지만 ___에는 ___습니다. → 내일 ___에는 ___습니다. → ___을/를 준비하세요.","rubric":["信息完整","核心语法","建议依据","可理解度","格式与语气"],"example":"서울 날씨입니다. 겨울에는 춥습니다. 오늘은 맑고 시원합니다. 낮에는 맑지만 밤에는 눈이 옵니다. 내일 아침에도 춥습니다. 겉옷을 준비하세요."},"coach":{"zh-CN":"三道阅读题全对，提交5—6句、五类信息齐全、主体正式体并完成五维量规自查。","ko-KR":"읽기 세 문제와 5~6문장, 다섯 정보, 격식체 및 자기 점검을 모두 완성합니다."},"nextNode":"can-do-check"}},
      {"code":"review","title":{"zh-CN":"自测与复盘","ko-KR":"자기 점검"},"description":{"zh-CN":"按五类错因返回最短复习路径。","ko-KR":"다섯 원인에 따라 가장 짧은 복습 경로로 돌아갑니다."},"nodeCode":"can-do-check","nodeTitle":{"zh-CN":"我能让别人根据播报做好准备吗？","ko-KR":"다른 사람이 안내를 듣고 준비할 수 있을까요?"},"content":{"lead":{"zh-CN":"自主复习展示不作为强制证据；综合多选与五项自查由合同记录。","ko-KR":"자율 복습은 필수 증거가 아니며 종합 문제와 다섯 점검을 기록합니다."},"canDo":[{"ko":"계절과 시간대에 맞는 날씨 표현을 사용할 수 있어요.","zh":"我能用合适词汇描述季节和时段天气。"},{"ko":"덥다와 춥다를 해요체와 격식체로 바르게 바꿀 수 있어요.","zh":"我能正确使用덥다/춥다的日常体和正式体。"},{"ko":"날씨 정보를 더할 때 -고, 대조할 때 -지만을 사용할 수 있어요.","zh":"我能用-고相加天气，用-지만表达反差。"},{"ko":"생활 날씨 안내문을 읽고 5~6문장의 새로운 예보를 쓸 수 있어요.","zh":"我能读懂天气公告并写5—6句新预报。"},{"ko":"오늘과 내일, 시간대 변화와 준비 안내를 넣어 50~70초 동안 날씨를 안내할 수 있어요.","zh":"我能加入今天、明天、时段变化和准备建议，完成50—70秒天气播报。"}],"remediation":[{"reason":"词汇","node":"weather-and-seasons"},{"reason":"语法","node":"weather-grammar-tools"},{"reason":"理解","node":"weather-before-going-out／listen-and-forecast"},{"reason":"表达","node":"listen-and-forecast"},{"reason":"读写","node":"city-weather-card"}],"chapterTest":"korean-level-one-07","coach":{"zh-CN":"综合多选答对，五项自查全部回应并记录返回节点或none后完成。","ko-KR":"종합 문제 정답과 다섯 점검 및 복습 위치 또는 none 기록이 필요합니다."}}}
    ] $chapter_seven_modules$::jsonb)
  loop
  ...
  set estimated_minutes = case node.node_code
        ...
        when 'weather-and-seasons' then 10
        when 'weather-grammar-tools' then 18
        when 'forecast-pattern-lab' then 12
        when 'weather-before-going-out' then 12
        when 'listen-and-forecast' then 15
        when 'city-weather-card' then 13
  ...
  for activity_seed in
    select value from jsonb_array_elements($chapter_seven_activities$
    [
  ...
  loop
    ...
    if activity_uuid is null then
      raise exception 'Cannot finalize chapter 07 activity %', activity_seed->>'key';
    end if;
  ...
  where activity.node_id = node.id
    ...
    and activity.activity_key not in (
      ...
      'dialogue-fact-check','dialogue-response','listening-forecast',
      'speaking-weather-report','reading-city-forecast','write-city-forecast',
  ...
  for media_seed in
    ...
    [
      {"nodeCode":"mission-map","key":"chapter-07-image-01","purpose":"章节情境主图","objectKey":"korean-level-one/chapter-07/images/chapter-07-01-scene.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-01-章节情境主图.png","alt":{"zh-CN":"水果店里成年顾客指着苹果向店员询价，价格牌不可读。","ko-KR":"과일 가게에서 성인 손님이 읽을 수 없는 가격표 옆 사과를 가리키며 직원에게 가격을 묻습니다."},"width":1600,"height":900},
      {"nodeCode":"weather-and-seasons","key":"chapter-07-image-02","purpose":"核心词汇商品与单位卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-02-vocabulary.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-02-核心词汇卡-商品与单位.png","alt":{"zh-CN":"五种商品与개、병数量分组。","ko-KR":"다섯 상품과 개, 병 수량 묶음입니다."},"width":1200,"height":900},
      {"nodeCode":"weather-grammar-tools","key":"chapter-07-image-03","purpose":"购物语言工具语法总图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03-grammar-overview.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03-语法总图-购物语言工具.png","alt":{"zh-CN":"动作请求、数量、评价和追加四轨结构。","ko-KR":"동작 요청, 수량, 평가와 추가의 네 갈래 구조입니다."},"width":1600,"height":900},
      {"nodeCode":"weather-grammar-tools","key":"chapter-07-image-04","purpose":"-(으)세요结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03a-euseyo.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03A-语法结构图-으세요.png","alt":{"zh-CN":"动词词干按收音分流到으세요或세요。","ko-KR":"동사 어간의 받침에 따라 으세요와 세요로 나뉩니다."},"width":1200,"height":900},
      {"nodeCode":"weather-grammar-tools","key":"chapter-07-image-05","purpose":"固有词数量与量词结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03b-counters.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03B-语法结构图-固有词量词.png","alt":{"zh-CN":"一至四缩略形、개和병与金额对比。","ko-KR":"하나부터 넷의 준말, 개와 병, 금액 비교입니다."},"width":1200,"height":900},
      {"nodeCode":"weather-grammar-tools","key":"chapter-07-image-06","purpose":"形容词谓语结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03c-adjective.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03C-语法结构图-形容词谓语.png","alt":{"zh-CN":"商品接이或가后连接价格与大小形容词。","ko-KR":"상품 뒤에 이나 가를 붙여 가격과 크기 형용사로 연결합니다."},"width":1200,"height":900},
      {"nodeCode":"weather-grammar-tools","key":"chapter-07-image-07","purpose":"名词도追加结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03d-do.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03D-语法结构图-名词도.png","alt":{"zh-CN":"第一件商品到追加商品的도替换关系。","ko-KR":"첫 상품에서 추가 상품으로 이어지는 도의 대체 관계입니다."},"width":1200,"height":900},
      {"nodeCode":"forecast-pattern-lab","key":"chapter-07-image-08","purpose":"句型交易语块卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-04-pattern-blocks.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-04-句型交易语块卡.png","alt":{"zh-CN":"六张完整购物话轮卡。","ko-KR":"여섯 장의 완전한 쇼핑 말차례 카드입니다."},"width":1200,"height":900},
      {"nodeCode":"weather-before-going-out","key":"chapter-07-image-09","purpose":"实战对话双场景图","objectKey":"korean-level-one/chapter-07/images/chapter-07-05-dialogue.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-05-实战对话场景.png","alt":{"zh-CN":"水果店和便利店雨具货架的两组顾客与店员。","ko-KR":"과일 가게와 편의점 우산 매대의 두 고객·직원 장면입니다."},"width":1600,"height":900},
      {"nodeCode":"listen-and-forecast","key":"chapter-07-image-10","purpose":"听力购物篮信息图","objectKey":"korean-level-one/chapter-07/images/chapter-07-06-listening-basket.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-06-听力信息图-购物篮.png","alt":{"zh-CN":"苹果、牛奶购物篮和随机金额卡，不显示数量答案。","ko-KR":"수량 답을 보여 주지 않는 사과, 우유 장바구니와 금액 카드입니다."},"width":1200,"height":900},
      {"nodeCode":"city-weather-card","key":"chapter-07-image-11","purpose":"今日价格卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-07-price-card.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-07-今日价格卡.png","alt":{"zh-CN":"按商品、销售单位和金额分成四行的今日价格卡。","ko-KR":"상품, 판매 단위와 금액을 네 줄로 정리한 오늘의 가격표입니다."},"width":1200,"height":1600},
      {"nodeCode":"can-do-check","key":"chapter-07-image-12","purpose":"最终双角色交易流程图","objectKey":"korean-level-one/chapter-07/images/chapter-07-08-final-task.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-08-最终任务图.png","alt":{"zh-CN":"从询价到付款的九步双角色流程。","ko-KR":"가격 질문부터 계산까지 아홉 단계 두 역할 흐름입니다."},"width":1600,"height":900}
    ] $images$::jsonb)
  loop
    select node.id into node_uuid
    from public.digital_textbook_nodes as node
  ...
  from public.digital_textbook_nodes as node
  join public.digital_textbook_modules as module on module.id = node.module_id
  where module.chapter_id = chapter_uuid and node.node_code = 'weather-and-seasons';
  ...
  select
    node_uuid,
    'chapter-07-vocabulary-' || lpad(item.ordinality::text, 2, '0'),
    'audio', '词汇原形点读',
    'korean-level-one/chapter-07/audio/vocabulary/chapter-07-vocabulary-' || lpad(item.ordinality::text, 2, '0') || '.mp3',
    'pending',
    '{"zh-CN":"词汇原形音频待制作","ko-KR":"어휘 기본형 음원 제작 대기"}'::jsonb,
    jsonb_build_object('audioId', 'chapter-07-vocabulary-' || lpad(item.ordinality::text, 2, '0'), 'script', item.value->>'word')
  ...
  select
    node_uuid,
    'chapter-07-vocabulary-collocation-' || lpad(item.ordinality::text, 2, '0'),
    'audio', '词汇搭配例句点读',
    'korean-level-one/chapter-07/audio/vocabulary/chapter-07-vocabulary-collocation-' || lpad(item.ordinality::text, 2, '0') || '.mp3',
    'pending',
    '{"zh-CN":"词汇搭配例句音频待制作","ko-KR":"어휘 결합 예문 음원 제작 대기"}'::jsonb,
    jsonb_build_object('audioId', 'chapter-07-vocabulary-collocation-' || lpad(item.ordinality::text, 2, '0'), 'script', item.value->>'collocation')
  from jsonb_array_elements($vocabulary$
    [{"word":"가격","collocation":"상품 가격"},{"word":"얼마","collocation":"얼마예요?"},{"word":"원","collocation":"천 원이에요."},{"word":"모두","collocation":"모두 얼마예요?"},{"word":"사과","collocation":"사과 세 개"},{"word":"바나나","collocation":"바나나 두 개"},{"word":"우유","collocation":"우유 한 병"},{"word":"물","collocation":"물 두 병"},{"word":"우산","collocation":"우산이 커요."},{"word":"가방","collocation":"가방이 비싸요."},{"word":"가게","collocation":"과일 가게"},{"word":"손님","collocation":"손님이 물어요."},{"word":"직원","collocation":"가게 직원"},{"word":"사다","collocation":"사과를 사요."},{"word":"고르다","collocation":"여기에서 고르세요."},{"word":"보다","collocation":"한번 보세요."},{"word":"싸다","collocation":"사과가 싸요."},{"word":"비싸다","collocation":"우산이 비싸요."},{"word":"크다","collocation":"우산이 커요."},{"word":"작다","collocation":"가방이 작아요."},{"word":"개","collocation":"세 개"},{"word":"병","collocation":"한 병"}]
  $vocabulary$::jsonb) with ordinality item(value, ordinality)
  on conflict (node_id, asset_key) do update set
  ...
  from public.digital_textbook_nodes as node
  join public.digital_textbook_modules as module on module.id = node.module_id
  where module.chapter_id = chapter_uuid and node.node_code = 'weather-grammar-tools';
  ...
  select
    ...
    'korean-level-one/chapter-07/audio/grammar/' || (item.value->>'id') || '.mp3',
    'pending',
  ...
  from jsonb_array_elements($grammar$
    [{"id":"chapter-07-grammar-01-example-01","script":"이 가방을 보세요."},{"id":"chapter-07-grammar-01-example-02","script":"네, 여기에서 고르세요."},{"id":"chapter-07-grammar-01-example-03","script":"한번 보세요."},{"id":"chapter-07-grammar-02-example-01","script":"사과 세 개 주세요."},{"id":"chapter-07-grammar-02-example-02","script":"사과 세 개 주세요."},{"id":"chapter-07-grammar-02-example-03","script":"민지는 사과 세 개를 사요."},{"id":"chapter-07-grammar-03-example-01","script":"이 사과가 싸요."},{"id":"chapter-07-grammar-03-example-02","script":"사과가 싸요."},{"id":"chapter-07-grammar-03-example-03","script":"이 우산이 커요."},{"id":"chapter-07-grammar-04-example-01","script":"우유도 한 병 주세요."},{"id":"chapter-07-grammar-04-example-02","script":"바나나도 두 개 주세요."},{"id":"chapter-07-grammar-04-example-03","script":"우유도 한 병 사요."}]
  ...
  from public.digital_textbook_nodes as node
  join public.digital_textbook_modules as module on module.id = node.module_id
  where module.chapter_id = chapter_uuid and node.node_code = 'weather-before-going-out';
  ...
  select
    ...
    'korean-level-one/chapter-07/audio/dialogue/' || (item.value->>'id') || '.mp3',
    'pending',
    '{"zh-CN":"对话音频待制作","ko-KR":"대화 음원 제작 대기"}'::jsonb,
    item.value - 'purpose'
  from jsonb_array_elements($dialogue$
    [{"id":"chapter-07-dialogue-main-line-01","purpose":"主对话逐句","script":"사과가 얼마예요?","speaker":"F01／민지"},{"id":"chapter-07-dialogue-main-line-02","purpose":"主对话逐句","script":"한 개에 천 원이에요.","speaker":"F02／수빈"},{"id":"chapter-07-dialogue-main-line-03","purpose":"主对话逐句","script":"사과가 싸요. 사과 세 개 주세요.","speaker":"F01／민지"},{"id":"chapter-07-dialogue-main-line-04","purpose":"主对话逐句","script":"네, 여기에서 고르세요.","speaker":"F02／수빈"},{"id":"chapter-07-dialogue-main-line-05","purpose":"主对话逐句","script":"바나나도 두 개 주세요.","speaker":"F01／민지"},{"id":"chapter-07-dialogue-main-line-06","purpose":"主对话逐句","script":"네, 바나나는 두 개에 이천 원이에요.","speaker":"F02／수빈"},{"id":"chapter-07-dialogue-main-line-07","purpose":"主对话逐句","script":"모두 얼마예요?","speaker":"F01／민지"},{"id":"chapter-07-dialogue-main-line-08","purpose":"主对话逐句","script":"모두 오천 원이에요.","speaker":"F02／수빈"},{"id":"chapter-07-dialogue-main-line-09","purpose":"主对话逐句","script":"네, 여기요.","speaker":"F01／민지"},{"id":"chapter-07-dialogue-main-line-10","purpose":"主对话逐句","script":"감사합니다.","speaker":"F02／수빈"},{"id":"chapter-07-dialogue-main","purpose":"主对话整段","script":"母本第6.1节完整双角色脚本","speaker":"F01／F02"},{"id":"chapter-07-dialogue-alt-line-01","purpose":"第二对话逐句","script":"이 우산이 얼마예요?","speaker":"M01／준호"},{"id":"chapter-07-dialogue-alt-line-02","purpose":"第二对话逐句","script":"만 원이에요.","speaker":"M02／현우"},{"id":"chapter-07-dialogue-alt-line-03","purpose":"第二对话逐句","script":"조금 비싸요. 저 우산도 만 원이에요?","speaker":"M01／준호"},{"id":"chapter-07-dialogue-alt-line-04","purpose":"第二对话逐句","script":"아니요, 칠천 원이에요. 이 우산이 커요. 한번 보세요.","speaker":"M02／현우"},{"id":"chapter-07-dialogue-alt-line-05","purpose":"第二对话逐句","script":"네, 이 우산 주세요.","speaker":"M01／준호"},{"id":"chapter-07-dialogue-alt-line-06","purpose":"第二对话逐句","script":"네, 감사합니다.","speaker":"M02／현우"},{"id":"chapter-07-dialogue-alt","purpose":"第二对话整段","script":"母本第6.2节完整双角色脚本","speaker":"M01／M02"}]
  ...
  where module.chapter_id = chapter_uuid
    and node.node_code = 'listen-and-forecast'
    and activity.activity_key = 'listening-forecast';

  insert into public.digital_textbook_media_assets (
    node_id, activity_id, asset_key, media_type, purpose, object_key,
    production_status, alt_text, metadata
  ) values
    (node_uuid,activity_uuid,'chapter-07-listening-forecast-normal','audio','私有听力正常语速','korean-level-one/chapter-07/listening/chapter-07-listening-forecast-normal.mp3','pending','{"zh-CN":"正常语速听力待制作","ko-KR":"보통 속도 듣기 음원 제작 대기"}'::jsonb,'{"speaker":"F03／第三人称旁白","scriptVisibility":"private","speed":"normal"}'::jsonb),
    (node_uuid,activity_uuid,'chapter-07-listening-forecast-slow','audio','私有听力慢速','korean-level-one/chapter-07/listening/chapter-07-listening-forecast-slow.mp3','pending','{"zh-CN":"慢速听力待制作","ko-KR":"느린 속도 듣기 음원 제작 대기"}'::jsonb,'{"speaker":"F03／第三人称旁白","scriptVisibility":"private","speed":"slow"}'::jsonb)
  on conflict (node_id, asset_key) do update set
  ...
  for media_seed in
    select value from jsonb_array_elements($chapter_seven_images$
    [
      {"key":"chapter-07-image-01","purpose":"章节情境主图","objectKey":"korean-level-one/chapter-07/images/chapter-07-01-scene.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-01-章节情境主图.png","alt":{"zh-CN":"学校大厅天气显示屏前，两名成年学生准备晚间外出。","ko-KR":"학교 로비 날씨 화면 앞에서 성인 학생 두 명이 저녁 외출을 준비합니다."},"width":1600,"height":900},
      {"key":"chapter-07-image-02","purpose":"核心词汇季节与天气卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-02-vocabulary.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-02-核心词汇卡-季节与天气.png","alt":{"zh-CN":"四季、五种天气、三个时段和两件准备物。","ko-KR":"사계절, 다섯 날씨, 세 시간대와 두 준비물입니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-03","purpose":"天气描述与播报语法总图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03-grammar-overview.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03-语法总图-天气描述与播报.png","alt":{"zh-CN":"不规则、相加、转折与正式体总流程。","ko-KR":"불규칙, 첨가, 대조와 격식체의 전체 흐름입니다."},"width":1600,"height":900},
      {"key":"chapter-07-image-04","purpose":"ㅂ不规则结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03a-b-irregular.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03A-语法结构图-ㅂ不规则.png","alt":{"zh-CN":"덥다和춥다按词尾起始音分流。","ko-KR":"덥다와 춥다가 어미 첫소리에 따라 나뉩니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-05","purpose":"-지만结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03b-jiman.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03B-语法结构图-지만.png","alt":{"zh-CN":"两项天气的反差箭头。","ko-KR":"두 날씨 정보의 대조 화살표입니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-06","purpose":"正式体结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03c-formal.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03C-语法结构图-正式体.png","alt":{"zh-CN":"词干收音分流到습니다或ㅂ니다。","ko-KR":"어간 받침에 따라 습니다와 ㅂ니다로 나뉩니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-07","purpose":"天气-고结构图","objectKey":"korean-level-one/chapter-07/images/chapter-07-03d-weather-go.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-03D-语法结构图-天气고.png","alt":{"zh-CN":"两项相加天气连接图。","ko-KR":"두 날씨 정보를 더하는 연결 그림입니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-08","purpose":"句型播报语块卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-04-pattern-blocks.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-04-句型播报语块卡.png","alt":{"zh-CN":"五张完整天气播报句卡。","ko-KR":"다섯 장의 완전한 날씨 안내 문장 카드입니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-09","purpose":"实战对话场景图","objectKey":"korean-level-one/chapter-07/images/chapter-07-05-dialogue.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-05-实战对话场景.png","alt":{"zh-CN":"大厅与教室窗边两组天气对话人物。","ko-KR":"로비와 교실 창가의 두 날씨 대화 장면입니다."},"width":1600,"height":900},
      {"key":"chapter-07-image-10","purpose":"听力今天明天时间线","objectKey":"korean-level-one/chapter-07/images/chapter-07-06-listening-timeline.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-06-听力信息图-今天明天.png","alt":{"zh-CN":"今天明天时间线和四种天气图标。","ko-KR":"오늘과 내일 시간선과 네 날씨 아이콘입니다."},"width":1200,"height":900},
      {"key":"chapter-07-image-11","purpose":"城市周末天气卡","objectKey":"korean-level-one/chapter-07/images/chapter-07-07-city-weekend.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-07-城市周末天气卡.png","alt":{"zh-CN":"手机天气公告栏风格的双日生活天气公告。","ko-KR":"휴대전화 날씨 앱 형식의 이틀 생활 날씨 안내입니다."},"width":1200,"height":1600},
      {"key":"chapter-07-image-12","purpose":"最终天气播报流程图","objectKey":"korean-level-one/chapter-07/images/chapter-07-08-final-task.png","plannedSourcePath":"../附件/韩国语1级/第07课/第07课-08-最终任务图.png","alt":{"zh-CN":"从城市季节到准备建议的一分钟播报流程。","ko-KR":"도시와 계절부터 준비 안내까지 이어지는 1분 안내 흐름입니다."},"width":1600,"height":900}
    ] $chapter_seven_images$::jsonb)
  loop
  ...
  for vocabulary_seed in
    select value, ordinality from jsonb_array_elements($chapter_seven_vocabulary$
    ...
    $chapter_seven_vocabulary$::jsonb) with ordinality item(value, ordinality)
  loop
    update public.digital_textbook_media_assets
    set metadata = jsonb_build_object('audioId','chapter-07-vocabulary-' || lpad(vocabulary_seed.ordinality::text,2,'0'),'script',vocabulary_seed.value->>'word'), updated_at = now()
    where node_id = node_uuid and asset_key = 'chapter-07-vocabulary-' || lpad(vocabulary_seed.ordinality::text,2,'0');
    update public.digital_textbook_media_assets
    set metadata = jsonb_build_object('audioId','chapter-07-vocabulary-collocation-' || lpad(vocabulary_seed.ordinality::text,2,'0'),'script',vocabulary_seed.value->>'collocation'), updated_at = now()
    where node_id = node_uuid and asset_key = 'chapter-07-vocabulary-collocation-' || lpad(vocabulary_seed.ordinality::text,2,'0');
  end loop;
  ...
  from jsonb_array_elements($chapter_seven_grammar_audio$
    [{"id":"chapter-07-grammar-01-example-01","script":"여름에는 날씨가 더워요."},{"id":"chapter-07-grammar-01-example-02","script":"낮에는 더워요. 바람도 불어요."},{"id":"chapter-07-grammar-01-example-03","script":"낮에는 따뜻하지만 밤에는 추워요."},{"id":"chapter-07-grammar-02-example-01","script":"낮에는 덥지만 밤에는 시원해요."},{"id":"chapter-07-grammar-02-example-02","script":"밤에는 시원하지만 비가 와요."},{"id":"chapter-07-grammar-02-example-03","script":"낮에는 덥지만 밤에는 시원합니다."},{"id":"chapter-07-grammar-03-example-01","script":"오늘 서울은 맑습니다."},{"id":"chapter-07-grammar-03-example-02","script":"내일 오전에는 흐리고 오후에는 비가 옵니다."},{"id":"chapter-07-grammar-03-example-03","script":"토요일 부산은 맑고 따뜻합니다."},{"id":"chapter-07-grammar-04-example-01","script":"오늘은 맑고 따뜻해요."},{"id":"chapter-07-grammar-04-example-02","script":"오전에는 흐리고 오후에는 맑아요."},{"id":"chapter-07-grammar-04-example-03","script":"일요일 오전에는 흐리고 오후에는 비가 옵니다."}]
  $chapter_seven_grammar_audio$::jsonb) grammar(value)
  ...
  where asset_key in ('chapter-07-dialogue-main-line-09','chapter-07-dialogue-main-line-10')
    and node_id in (select node.id from public.digital_textbook_nodes node join public.digital_textbook_modules module on module.id=node.module_id where module.chapter_id=chapter_uuid);

  update public.digital_textbook_media_assets as media
  set metadata = dialogue.value - 'purpose', purpose = dialogue.value->>'purpose', updated_at = now()
  from jsonb_array_elements($chapter_seven_dialogue_audio$
    [{"id":"chapter-07-dialogue-main-line-01","purpose":"主对话逐句","script":"오늘 날씨가 어때요?","speaker":"F01／지민"},{"id":"chapter-07-dialogue-main-line-02","purpose":"主对话逐句","script":"아침에는 맑고 따뜻해요.","speaker":"M01／준호"},{"id":"chapter-07-dialogue-main-line-03","purpose":"主对话逐句","script":"낮에도 따뜻해요?","speaker":"F01／지민"},{"id":"chapter-07-dialogue-main-line-04","purpose":"主对话逐句","script":"아니요. 낮에는 더워요. 바람도 불어요.","speaker":"M01／준호"},{"id":"chapter-07-dialogue-main-line-05","purpose":"主对话逐句","script":"밤에는 어때요?","speaker":"F01／지민"},{"id":"chapter-07-dialogue-main-line-06","purpose":"主对话逐句","script":"밤에는 시원하지만 비가 와요.","speaker":"M01／준호"},{"id":"chapter-07-dialogue-main-line-07","purpose":"主对话逐句","script":"그럼 우산이 필요해요?","speaker":"F01／지민"},{"id":"chapter-07-dialogue-main-line-08","purpose":"主对话逐句","script":"네, 우산을 가져가세요.","speaker":"M01／준호"},{"id":"chapter-07-dialogue-main","purpose":"主对话整段","script":"母本第6.1节完整双角色脚本","speaker":"F01／M01"},{"id":"chapter-07-dialogue-alt-line-01","purpose":"第二对话逐句","script":"내일 날씨가 어때요?","speaker":"F02／소라"},{"id":"chapter-07-dialogue-alt-line-02","purpose":"第二对话逐句","script":"오전에는 흐리고 오후에는 맑아요.","speaker":"M02／민수"},{"id":"chapter-07-dialogue-alt-line-03","purpose":"第二对话逐句","script":"기온은 어때요?","speaker":"F02／소라"},{"id":"chapter-07-dialogue-alt-line-04","purpose":"第二对话逐句","script":"낮에는 따뜻하지만 밤에는 추워요.","speaker":"M02／민수"},{"id":"chapter-07-dialogue-alt-line-05","purpose":"第二对话逐句","script":"그럼 겉옷이 필요해요?","speaker":"F02／소라"},{"id":"chapter-07-dialogue-alt-line-06","purpose":"第二对话逐句","script":"네, 겉옷을 가져가세요.","speaker":"M02／민수"},{"id":"chapter-07-dialogue-alt","purpose":"第二对话整段","script":"母本第6.2节完整双角色脚本","speaker":"F02／M02"}]
  $chapter_seven_dialogue_audio$::jsonb) dialogue(value)
  ...
  where media.node_id = node.id
    and node.module_id = module.id
    and module.chapter_id = chapter_uuid
    and media.asset_key not like 'chapter-07-%';
end;
$seed$;
