  ...
  return (
    <>
      <section className={`${styles.heroGrid} relative isolate overflow-hidden pb-20 pt-14 sm:pb-28 sm:pt-20`}>
        ...
        <div className="pointer-events-none absolute -left-24 top-36 h-72 w-72 rounded-full bg-[#ffdfcf]/55 blur-3xl" />
        ...
        <div className="relative mx-auto grid max-w-7xl items-center gap-14 px-5 sm:px-8 lg:grid-cols-[1.04fr_0.96fr] lg:gap-12">
          <div className="text-center lg:text-left">
            ...
            <h1 className="mx-auto mt-7 max-w-3xl text-[2.65rem] font-black leading-[1.12] tracking-[-0.045em] text-[#153754] sm:text-5xl lg:mx-0 lg:text-6xl">
              ...
              <span className="relative mt-2 inline-block text-[#f06f53]">
                看得见的成长
                <span className="absolute -bottom-1 left-0 h-3 w-full -rotate-1 rounded-full bg-[#ffd5c8]/70 -z-10" />
              </span>
            </h1>
            ...
            <div className="mt-9 flex flex-col justify-center gap-3 sm:flex-row lg:justify-start">
              <Link
                href="/register"
                className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-[#f5795e] px-7 py-4 text-base font-black text-white shadow-[0_16px_35px_rgba(245,121,94,0.28)] transition hover:-translate-y-1 hover:bg-[#e9684e]"
              >
                获取专属成长方案
              ...
              <Link
                href="#growth-path"
                className="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#bdd9ea] bg-white/90 px-7 py-4 text-base font-black text-[#245776] shadow-sm transition hover:-translate-y-1 hover:border-[#78bde5] hover:bg-[#f5fbff]"
              >
                <Compass size={18} />
                查看双线成长路线
              </Link>
          ...
          <div className="relative mx-auto w-full max-w-[560px] lg:ml-auto">
            <div className={`${styles.softFloat} absolute -left-5 -top-10 z-20 hidden rounded-2xl border border-[#ffd5c8] bg-white px-4 py-3 shadow-[0_16px_40px_rgba(68,112,143,0.15)] sm:block`}>
              <div className="flex items-center gap-3">
                <span className="flex h-10 w-10 items-center justify-center rounded-xl bg-[#fff0e9] text-[#ef7458]">
            ...
            <div className="relative overflow-hidden rounded-[2.25rem] border border-white/90 bg-white/92 p-5 shadow-[0_30px_80px_rgba(48,107,147,0.18)] backdrop-blur sm:p-7">
              ...
              <div className="relative flex items-center justify-between border-b border-[#e8f1f6] pb-5">
                <div className="flex items-center gap-3">
                  <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#e7f5ff] text-[#348ac0]">
                    <Plane size={23} />
                  </span>
                  <div>
                ...
                <span className="rounded-full bg-[#fff1ea] px-3 py-1.5 text-xs font-black text-[#e9694e]">
                  进行中
                </span>
              </div>

              <div className="relative mt-6 space-y-5">
                <div className="absolute bottom-6 left-[18px] top-6 w-px bg-gradient-to-b from-[#6ab9e8] via-[#ff9a7d] to-[#75c995]" />
                {preparationItems.map((item, index) => (
                  <div key={item.label} className="relative flex items-center gap-4 rounded-2xl bg-[#f8fbfd] p-4">
                    ...
                    {index === 0 ? (
                      ...
                      <CalendarCheck2 className="text-[#ec7558]" size={20} />
                    ) : (
              ...
              <div className="mt-6 grid grid-cols-2 gap-3">
                <div className="rounded-2xl bg-[#eaf7ff] p-4">
                ...
                <div className="rounded-2xl bg-[#fff2eb] p-4">
                  <p className="text-xs font-bold text-[#8e776b]">今日学习建议</p>
                  <p className="mt-1 text-sm font-black text-[#9b4d3b]">练习校园情境表达</p>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* 循环信息带让首屏与后续内容自然衔接。 */}
      <div className="overflow-hidden border-y border-[#d9ecf7] bg-[#eef9ff] py-4" aria-label="服务范围">
        <div className={styles.marqueeTrack}>
          {[...marqueeItems, ...marqueeItems].map((item, index) => (
            <div key={`${item}-${index}`} className="flex items-center gap-5 px-5 text-sm font-black text-[#3d718e] sm:px-8 sm:text-base">
              <span className="h-2 w-2 rounded-full bg-[#f58366]" />
              {item}
            </div>
          ))}
        </div>
