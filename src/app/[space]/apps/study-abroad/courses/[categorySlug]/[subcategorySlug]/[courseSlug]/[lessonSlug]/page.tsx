...
export default async function StudyAbroadLessonPage({ params, searchParams }: {
  ...
  return <LessonPage params={Promise.resolve({ categorySlug, subcategorySlug, courseSlug, lessonSlug })} searchParams={searchParams} courseBasePath={getStudentAppCoursesPath(space, "study-abroad")} />;
}
