...
export default async function StudyAbroadSubcategoryPage({ params }: {
  ...
  return <SubcategoryPage params={Promise.resolve({ categorySlug, subcategorySlug })} courseBasePath={getStudentAppCoursesPath(space, "study-abroad")} />;
}
