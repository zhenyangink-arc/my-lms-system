...
export function KoreanLevelOneLessonTenBook({
  ...
  function renderPage(number: string) {
    ...
    const pages: Record<string, ReactNode> = {
      ...
      "34": <div className="flex h-full flex-col justify-center"><div className="mx-auto w-full max-w-[440px] text-center"><span className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-[var(--status-success-surface)] text-[var(--status-success)]"><Sparkles aria-hidden="true" size={27} /></span><h3 className="mt-3 text-4xl font-bold">지금 몇 시예요?</h3><p className="mt-3 text-lg font-bold">你已经完成第十课</p><p className="mx-auto mt-3 max-w-[390px] text-sm leading-7 text-[var(--foreground-secondary)]">现在你能准确表达时刻和日程范围，区分两种动作连接方式，并完整说明未来计划。</p><div className="mt-4 grid grid-cols-2 gap-3 text-left">{[
