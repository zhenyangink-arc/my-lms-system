    ...
    <div className="pb-12">
      <div className="mx-auto mt-5 w-full max-w-[1500px] space-y-5 px-4 sm:px-6 lg:px-8">
        ...
        <section className="space-y-4">
          ...
          {!error && announcements.length === 0 && <div className="app-card rounded-3xl border border-dashed p-8 text-center"><BellRing className="mx-auto opacity-30" size={34} aria-hidden="true" /><h2 className="mt-4 font-bold">当前没有新公告</h2><p className="app-muted-text mt-2 text-sm">后台发布通知后，会自动显示在这里。</p></div>}
        </section>
      </div>
    </div>
  );
