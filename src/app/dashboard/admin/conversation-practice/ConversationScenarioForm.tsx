          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[980px] table-fixed border-collapse text-left">
              <tbody className="divide-y">
                <tr>
                  <th colSpan={4} className="bg-[var(--surface-soft)] px-3 py-2 text-[11px] font-semibold" style={{ color: "var(--primary-hover)" }}>基础信息</th>
                </tr>
                <tr>
                ...
                <tr>
                  <th colSpan={4} className="bg-[var(--surface-soft)] px-3 py-2 text-[11px] font-semibold" style={{ color: "var(--primary-hover)" }}>练习内容</th>
                </tr>
                <tr>
                ...
                <tr>
                  <th colSpan={4} className="bg-[var(--surface-soft)] px-3 py-2 text-[11px] font-semibold" style={{ color: "var(--primary-hover)" }}>发布设置</th>
                </tr>
                <tr>
