                ...
                >
                  <tr className="border-b app-muted-text">
                    {[`${typeLabel}卷`, "来源章节", "题量 / 总分", "时长", "及格线", "状态", "版本", "更新时间", "操作"].map((label, index) => (
                      <th
                        key={label}
                        className={`${index > 0 ? "border-l" : ""} px-3 py-2 text-[11px] font-bold ${index >= 2 && index <= 7 ? "text-center" : index === 8 ? "text-right" : ""}`}
                      >
                        {label}
                      </th>
                    ))}
                  ...
                  {papers.map((paper) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="border-l px-3 py-2 text-center font-mono text-xs tabular-nums">
                        ...
                        <td className="border-l px-3 py-2 text-center text-[11px]">
                ...
                <table className="w-full table-fixed border-collapse text-left">
                  ...
                  <thead className="sticky top-0 z-20 backdrop-blur-xl" style={{ backgroundColor: "color-mix(in srgb, var(--card) 84%, transparent)" }}>
                    <tr className="border-b app-muted-text">
                      {["作业任务", "使用试卷", "关联课程", "指向学生", "开始 / 截止", "提交 / 待批改", "状态", "操作"].map((label, index) => (
                        <th key={label} className={`${index > 0 ? "border-l" : ""} px-3 py-2 text-[11px] font-bold ${index >= 3 && index <= 6 ? "text-center" : index === 7 ? "text-right" : ""}`}>
                          {label}
                        </th>
                      ))}
                    </tr>
                  ...
                  <tbody>
                    {assignments.map((assignment) => {
                      ...
                      return (
                        <tr key={assignment.id} className="border-b align-middle last:border-b-0 hover:bg-[var(--surface-soft)]" style={{ borderColor: "var(--border-subtle)" }}>
                          ...
                          <td className="border-l px-3 py-2 font-mono text-[11px]">
                          ...
                          <td className="border-l px-3 py-2 text-center text-xs">
                            <span title={targetLabel}>{targetLabel}</span>
                          </td>
                          <td className="border-l px-3 py-2 text-center text-[11px] leading-5">
                          ...
                          <td className="border-l px-3 py-2 text-center text-[11px] font-bold">
                    ...
                    {assignments.length === 0 && (
                      <tr>
                        <td colSpan={8} className="app-muted-text px-5 py-12 text-center text-xs">
