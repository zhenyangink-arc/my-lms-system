        ...
        <div className="app-card flex h-dvh flex-col overflow-hidden">
          ...
          >
            ...
            >
              ...
              >
                <div>
                  <h3 className="font-semibold">随机选题结果</h3>
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[920px] table-fixed border-collapse text-left">
                  ...
                  <thead>
                    ...
                    >
                      <th className="w-20 px-4 py-2 text-center text-[11px] font-bold">
                        序号
                      </th>
                      <th className="w-28 border-l px-4 py-2 text-center text-[11px] font-bold">
                        难度
                      </th>
                  ...
                  <tbody>
                    {selectedQuestions.map((question, index) => (
                      ...
                      >
                        ...
                        <td className="border-l px-4 py-2 text-center text-xs font-bold">
                          {QUESTION_DIFFICULTY_LABELS[question.difficulty]}
                        </td>
                        <td className="border-l px-4 py-2 text-xs font-bold leading-5">
                          {question.prompt}
                        </td>
                          ...
                          {question.options.map((option, optionIndex) => {
                            ...
                            return (
                              ...
                              >
                                ...
                                <span>{option}</span>
                                {isCorrect && (
                                  <span className="ml-auto inline-flex items-center gap-1 whitespace-nowrap text-[10px] font-bold text-[var(--status-success)]">
                                    <Check size={11} />
                                    正确答案
                                  </span>
                                )}
