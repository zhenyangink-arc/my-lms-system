              ...
              >
                <table className="w-full min-w-[980px] table-fixed border-collapse text-left">
                  ...
                  >
                    ...
                    >
                      <th className="px-4 py-2 font-bold">课程 / 课时</th>
                      <th className="border-l px-4 py-2 font-bold">章节测试</th>
                      <th className="border-l px-3 py-2 text-center font-bold">
                        状态
                      </th>
                      <th className="border-l px-3 py-2 text-center font-bold">
                        题量
                      ...
                      <th className="border-l px-4 py-2 text-right font-bold">
                        快捷操作
                      </th>
                    </tr>
                  </thead>
                      ...
                      return group.tests.map((test, testIndex) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="border-l px-3 py-2 text-center font-mono text-xs font-bold tabular-nums">
