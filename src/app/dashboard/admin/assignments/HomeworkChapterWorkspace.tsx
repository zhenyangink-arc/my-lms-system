              ...
              >
                <table className="w-full min-w-[1180px] table-fixed border-collapse text-left">
                  ...
                  >
                    ...
                    >
                      <th className="px-4 py-2">课程 / 课时</th>
                      <th className="border-l px-4 py-2">章节作业</th>
                      <th className="border-l px-3 py-2 text-center">状态</th>
                      <th className="border-l px-3 py-2 text-center">词</th>
                      <th className="border-l px-3 py-2 text-center">语法</th>
                      <th className="border-l px-3 py-2 text-center">听</th>
                      <th className="border-l px-3 py-2 text-center">说</th>
                      <th className="border-l px-3 py-2 text-center">读</th>
                      <th className="border-l px-3 py-2 text-center">写</th>
                      <th className="border-l px-3 py-2 text-center">
                        标准卷
                      </th>
                      <th className="border-l px-2 py-2 text-right">操作</th>
                    </tr>
                  </thead>
                    ...
                    >
                      {group.chapters.length === 0 ? (
                        <tr
                          ...
                          style={{ borderColor: "var(--border-subtle)" }}
                        >
                          <td className="app-muted-text relative px-4 py-2 text-xs">
                            <span
                              aria-hidden="true"
                          ...
                          <td
                            className="app-muted-text border-l px-4 py-2 text-xs"
                            colSpan={10}
                          >
                            暂未建立章节作业
                          </td>
