                ...
                <table className="w-full min-w-[820px] table-fixed border-collapse text-left">
                  ...
                  <thead className="bg-[var(--surface-soft)]">
                    <tr className="border-b app-muted-text">
                      <th className="px-3 py-2 text-center text-[11px] font-bold">难度</th>
                      <th className="border-l px-3 py-2 text-center text-[11px] font-bold">技能</th>
                      <th className="border-l px-4 py-2 text-[11px] font-bold">题目</th>
                      <th className="border-l px-4 py-2 text-[11px] font-bold">选项</th>
                      <th className="border-l px-3 py-2 text-right text-[11px] font-bold">操作</th>
                    </tr>
                  </thead>
                  <tbody>
                    {visible.map((question) => {
                      ...
                      return (
                        <tr key={question.id} className="border-b align-top last:border-b-0" style={{ borderColor: "var(--border-subtle)" }}>
                          <td className="px-3 py-2 text-center text-xs font-bold">{difficultyLabels[question.difficulty] ?? question.difficulty}</td>
                          <td className="app-muted-text border-l px-3 py-2 text-center text-xs">{question.skill || "综合"}</td>
            ...
            <section className="border">
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[760px] border-collapse text-left">
                  <thead className="bg-[var(--surface-soft)]">
                    <tr className="border-b app-muted-text">
                      <th className="w-16 px-3 py-2 text-center text-[11px] font-bold">顺序</th>
                      <th className="border-l px-4 py-2 text-[11px] font-bold">题目</th>
                      <th className="w-24 border-l px-3 py-2 text-center text-[11px] font-bold">分值</th>
                      <th className="w-36 border-l px-3 py-2 text-right text-[11px] font-bold">操作</th>
                    </tr>
                  </thead>
                  <tbody>
                    {selected.map((item, index) => {
                      ...
                      return (
                        <tr key={item.questionId} className="border-b last:border-b-0" style={{ borderColor: "var(--border-subtle)" }}>
                          ...
                          <td className="border-l px-4 py-2 text-xs font-bold">{question.prompt}</td>
