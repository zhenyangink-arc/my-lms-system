...
function HomeworkQuestionRow({
  ...
  return (
    ...
    >
      <td className="px-3 py-2 text-center font-mono text-[10px] font-semibold tabular-nums">
        {String(index + 1).padStart(2, "0")}
      </td>
      <td className="border-l px-3 py-2 text-[10px] leading-5">
      ...
      <td className="border-l px-3 py-2 text-[11px] leading-5">
      ...
      <td
        className="border-l px-3 py-2 text-[11px] font-bold leading-5"
      ...
      <td className="app-muted-text border-l px-3 py-2 text-[10px] leading-5">
      ...
      <td className="border-l px-3 py-2 text-center font-mono text-xs font-semibold tabular-nums">
        {question.points}
      </td>
    </tr>
  );
        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[1320px] table-fixed border-collapse text-left">
            ...
            <thead>
              ...
              >
                <th className="px-3 py-2 text-center text-[10px] font-bold">
                  题号
                </th>
                <th className="border-l px-3 py-2 text-[10px] font-bold">
                  题型 / 来源
                </th>
                <th className="border-l px-4 py-2 text-[10px] font-bold">
                  材料 / 题目
                </th>
                <th className="border-l px-3 py-2 text-[10px] font-bold">
                  选项
                ...
                <th className="border-l px-3 py-2 text-center text-[10px] font-bold">
                  分值
                </th>
              </tr>
            </thead>
