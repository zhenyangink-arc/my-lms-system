            ...
            <div className="min-h-0 flex-1 overflow-auto">
              <table className="w-full min-w-[900px] table-fixed border-collapse text-left">
                ...
                <thead className="sticky top-0 z-10 backdrop-blur-xl">
                  ...
                  >
                    <th className="px-3 py-2 text-center text-[11px] font-bold">
                      题号
                    </th>
                    <th className="border-l px-3 py-2 text-center text-[11px] font-bold">
                      难度
                    </th>
                ...
                <tbody>
                  {questions.map((question, index) => (
                    ...
                    >
                      ...
                      <td className="border-l px-3 py-2 text-center text-xs font-bold">
                      ...
                      <td className="app-muted-text border-l px-4 py-2 text-xs leading-5">
