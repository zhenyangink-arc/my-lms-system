  ...
  return (
    <div className="pb-12">
      <div className="mx-auto mt-5 w-full max-w-[1720px] space-y-5 px-4 sm:px-6 lg:px-8">
        ...
        {canManageArticles && (
          <section className="border-y border-black/[0.08] bg-white">
            <header className="flex items-center justify-between gap-4 border-b border-black/[0.08] px-5 py-4"><div><h2 className="text-sm font-semibold text-zinc-950">帮助文章</h2><p className="mt-1 text-[10px] text-zinc-500">草稿不会出现在学生端。</p></div><ArticleDialog /></header>
