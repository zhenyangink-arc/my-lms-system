              ...
              <details key={lesson.courseKey} open={lessonIndex === 0} className="border-b last:border-b-0">
                ...
                <div className="overflow-x-auto border-t">
                  <table className="w-full min-w-[1180px] border-collapse text-left">
                    <thead><tr className="border-b bg-[var(--surface-soft)] app-muted-text"><th className="px-4 py-2 text-[11px]">章节</th><th className="border-l px-4 py-2 text-[11px]">章节标题</th><th className="border-l px-4 py-2 text-center text-[11px]">听力</th><th className="border-l px-4 py-2 text-center text-[11px]">口语</th><th className="border-l px-4 py-2 text-center text-[11px]">阅读</th><th className="border-l px-4 py-2 text-center text-[11px]">写作</th><th className="border-l px-4 py-2 text-center text-[11px]">资源</th><th className="border-l px-4 py-2 text-center text-[11px]">题目合计</th><th className="border-l px-4 py-2 text-right text-[11px]">操作</th></tr></thead>
                    <tbody>
