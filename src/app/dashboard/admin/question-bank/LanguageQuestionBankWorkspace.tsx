    ...
    <div className="pb-12">
      <div className="mx-auto mt-6 w-full max-w-[1500px] space-y-5 px-4 sm:px-6 lg:px-8">
        ...
        <section className="border" style={{ borderColor: "var(--app-border)" }}>
          <h3 className="border-b bg-[var(--app-soft-bg)] px-4 py-3 text-sm font-black">韩语初级</h3>
          {lessonGroups.map((lesson, lessonIndex) => {
            ...
            return (
              <details key={lesson.courseKey} open={lessonIndex === 0} className="border-b last:border-b-0">
                <summary className="flex cursor-pointer list-none items-center justify-between gap-3 bg-[var(--app-card-bg)] px-4 py-3 hover:bg-[var(--app-soft-bg)]"><span className="text-sm font-black">{lesson.label}</span><span className="app-muted-text text-[11px] font-black">{lessonChapters.length} 个章节</span></summary>
