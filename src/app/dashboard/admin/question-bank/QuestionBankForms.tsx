      ...
      <div className="overflow-x-auto border">
        <table className="w-full min-w-[820px] border-collapse text-left text-xs">
          <tbody className="divide-y">
            <tr>
              <th className="w-32 bg-[var(--surface-soft)] px-3 py-3 font-semibold">课程章节</th>
              ...
              <th className="w-32 border-l bg-[var(--surface-soft)] px-3 py-3 font-semibold">题型</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">难度</th>
              ...
              <th className="border-l bg-[var(--surface-soft)] px-3 py-3 font-semibold">默认分值</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">题目</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">四个选项</th>
              ...
              <th className="border-l bg-[var(--surface-soft)] px-3 py-3 font-semibold">正确选项序号</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">知识点</th>
              ...
              <th className="border-l bg-[var(--surface-soft)] px-3 py-3 font-semibold">标签</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">标准解析</th>
            ...
            <tr>
              <th className="bg-[var(--surface-soft)] px-3 py-3 font-semibold">发布状态</th>
