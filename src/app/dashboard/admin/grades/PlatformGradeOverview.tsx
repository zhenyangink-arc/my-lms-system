            ...
            <table className="w-full min-w-[1280px] border-collapse text-left">
              <thead>
                <tr
                  ...
                  style={{ borderColor: "var(--border)" }}
                >
                  <th className="w-[20%] px-5 py-2 font-semibold">机构</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">活跃学生</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">已发布任务</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">成绩记录</th>
                  <th className="w-[11%] px-3 py-2 font-semibold">平均得分率</th>
                  <th className="w-[10%] px-3 py-2 font-semibold">通过率</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">待复核</th>
                  <th className="w-[11%] px-3 py-2 font-semibold">最近成绩</th>
