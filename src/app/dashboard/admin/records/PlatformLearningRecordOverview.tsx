            ...
            <table className="w-full min-w-[1280px] border-collapse text-left">
              <thead>
                <tr
                  ...
                  style={{ borderColor: "var(--border)" }}
                >
                  <th className="w-[21%] px-5 py-2 font-semibold">机构</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">活跃学生</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">有效记录</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">学生可见</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">内部记录</th>
                  <th className="w-[10%] px-3 py-2 text-center font-semibold">关注事项</th>
                  <th className="w-[9%] px-3 py-2 text-center font-semibold">学习计划</th>
                  <th className="w-[12%] px-3 py-2 font-semibold">最近记录</th>
                  <th className="w-[8%] px-5 py-2 font-semibold">操作</th>
                </tr>
              </thead>
              <tbody>
                {rows.map((row) => (
                  ...
                  >
                    ...
                    <td className="px-3 py-2 text-center font-mono font-semibold" style={{ color: "var(--status-warning)" }}>
                      {numberValue(row.attention_record_count)}
                    </td>
                    <td className="px-3 py-2 text-center font-mono font-semibold">
                      {numberValue(row.plan_record_count)}
                    </td>
                    <td className="app-muted-text px-3 py-2 text-[10px]">
                      {row.last_record_at
