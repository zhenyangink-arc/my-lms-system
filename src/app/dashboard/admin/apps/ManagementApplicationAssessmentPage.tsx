            ...
            <div className="overflow-x-auto border bg-[var(--card)]">
              <table className="w-full min-w-[760px] border-collapse text-left text-xs">
                ...
                <thead className="bg-[var(--surface-soft)] app-muted-text">
                  <tr>
                    <th className="px-4 py-2">试卷</th>
                    <th className="px-4 py-2">类型</th>
                    <th className="px-4 py-2">来源章节</th>
                    <th className="px-4 py-2">题量</th>
                    <th className="px-4 py-2">满分</th>
            ...
            <tbody>
              {tests.map((test) => (
                ...
                >
                  ...
                  <td className="px-4 py-2 font-medium">{test.title}</td>
                  <td className="app-muted-text px-4 py-2">
