        ...
        <section className="border-y border-black/[0.08] bg-white">
          ...
          <div className="overflow-x-auto">
            <table className="w-full min-w-[1420px] border-collapse text-left">
              <thead>
                <tr className="h-9 border-b border-black/[0.08] bg-zinc-50/40 text-[9px] uppercase tracking-[0.07em] text-zinc-500">
                          ...
                          <td colSpan={11} className="px-12 py-2">
                            <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_320px]">
                              <table className="w-full border-collapse text-left text-[10px]">
                                ...
                                <tbody>
                                  {item.tasks.map((task) => (
                                    <tr key={task.id} className="h-9 border-b border-black/[0.05] last:border-b-0">
