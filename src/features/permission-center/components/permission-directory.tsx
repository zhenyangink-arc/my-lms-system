      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[980px] border-collapse text-left text-xs">
          <thead className="bg-[var(--surface-soft)] text-[var(--foreground-muted)]">
            <tr>
              <th className="px-4 py-2 font-medium">权限键</th>
              <th className="px-4 py-2 font-medium">权限名称</th>
              <th className="px-4 py-2 font-medium">适用范围</th>
              <th className="px-4 py-2 font-medium">可授权账号</th>
              <th className="px-4 py-2 font-medium">覆盖能力</th>
            </tr>
          </thead>
          <tbody>
            {directory.assignablePermissionKeys.map((permissionKey) => {
              ...
              return (
                ...
                >
                  <td className="px-4 py-2 font-mono text-[11px] text-[var(--foreground-muted)]">
                    {permissionKey}
                  </td>
                  <td className="px-4 py-2 font-semibold text-[var(--foreground)]">
                    {directory.assignablePermissionLabels[permissionKey]}
                  </td>
                  <td className="px-4 py-2">{scopeLabel(permissionKey)}</td>
                  <td className="px-4 py-2">{targetLabel(permissionKey)}</td>
                  <td className="max-w-md px-4 py-2 text-[var(--foreground-muted)]">
    ...
    <section className="overflow-hidden border border-[var(--border)] bg-[var(--card)]">
      ...
      <div className="overflow-x-auto">
        <table className="w-full min-w-[920px] border-collapse text-left text-xs">
          <thead className="bg-[var(--surface-soft)] text-[var(--foreground-muted)]">
            <tr>
              <th className="w-44 px-4 py-2 font-medium">角色</th>
              <th className="w-28 px-4 py-2 font-medium">身份范围</th>
              <th className="px-4 py-2 font-medium">固定继承能力</th>
            </tr>
          </thead>
          <tbody>
