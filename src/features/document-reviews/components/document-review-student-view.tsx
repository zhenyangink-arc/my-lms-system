              ...
              <table className="w-full min-w-[980px] border-collapse text-left text-xs">
                <thead className="bg-[var(--surface-soft)] text-[var(--foreground-muted)]">
                  <tr>
                    ...
                    <th className="px-4 py-2 font-medium">邮寄日期</th>
                    <th className="px-4 py-2 font-medium">预计到达</th>
                  </tr>
                </thead>
                <tbody>
                  <tr>
              ...
              <table className="w-full min-w-[1080px] border-collapse text-left text-xs">
                <thead className="bg-[var(--surface-soft)] text-[var(--foreground-muted)]">
                  <tr>
                    ...
                    <th className="px-4 py-2 font-medium">学生说明</th>
                ...
                <tbody>
                  {documents.map((document) => (
                    ...
                    >
                      ...
                      <td className="max-w-64 whitespace-pre-wrap px-4 py-2 text-[var(--foreground-secondary)]">
                        {document.notes || "—"}
                      </td>
                      <td className="max-w-64 whitespace-pre-wrap px-4 py-2 text-[var(--foreground-secondary)]">
                        {document.admin_note || "—"}
