...
export function ModelUsageActivityDialog({
  ...
  if (row.logCount === 0) {
    return <span className="text-xs text-[var(--app-muted)]">暂无调用</span>;
  }
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-3xl">
        ...
        <div className="max-h-[60vh] overflow-auto border border-[var(--app-border)]">
          <table className="w-full min-w-[620px] border-collapse text-left text-xs">
            <thead className="sticky top-0 bg-[var(--app-soft-bg)] text-[var(--app-muted)]">
              <tr>
