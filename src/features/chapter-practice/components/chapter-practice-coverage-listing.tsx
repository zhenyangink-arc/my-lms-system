            ...
            <div className="hidden overflow-x-auto 2xl:block">
              <table className="w-full min-w-[1240px] border-collapse text-left text-xs">
                ...
                <thead className="bg-[var(--muted)] text-[var(--foreground-secondary)]">
                  <tr>
                    <th scope="col" className="w-[280px] px-3 py-2 font-semibold">课程、课时与章节</th>
                    <th scope="col" className="w-[145px] px-3 py-2 font-semibold">发布状态</th>
                    <th scope="col" className="w-[175px] px-3 py-2 font-semibold">教材与核心内容</th>
                    <th scope="col" className="w-[250px] px-3 py-2 font-semibold">六项练习</th>
                    <th scope="col" className="w-[150px] px-3 py-2 font-semibold">作业与测试</th>
                    <th scope="col" className="w-[175px] px-3 py-2 font-semibold">巩固内容</th>
                    <th scope="col" className="w-[165px] px-3 py-2 font-semibold">同步与更新</th>
                    <th scope="col" className="w-[130px] px-3 py-2 font-semibold">操作</th>
                  </tr>
                </thead>
                <tbody className="divide-y">
                  {result.rows.map((row) => (
                    <tr key={row.id} className="align-top hover:bg-[var(--muted)]/40">
                      ...
                      <td className="px-3 py-2"><SourceCoverage row={row} /></td>
                      <td className="px-3 py-2"><SkillCoverage row={row} /></td>
                      <td className="px-3 py-2"><AssignmentCoverage row={row} /></td>
                      <td className="px-3 py-2">
