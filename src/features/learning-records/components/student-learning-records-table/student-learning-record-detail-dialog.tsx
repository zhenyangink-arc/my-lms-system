...
function CountCell({ value }: { value: number }) {
  return (
    <td className="border-r border-[var(--border-subtle)] px-4 py-3 font-mono text-base font-semibold tabular-nums last:border-r-0">
        ...
        <div className="overflow-x-auto border-b border-[var(--border)]">
          <table className="w-full min-w-[760px] border-collapse text-left text-xs">
            <thead className="bg-[var(--surface-soft)] text-[var(--foreground-muted)]">
              <tr>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">统计项目</th>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">完成课时</th>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">学习中课时</th>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">任务提交</th>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">会话练习</th>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">成绩记录</th>
                <th className="px-4 py-3 font-medium">人工辅导备注</th>
              </tr>
            </thead>
            <tbody>
              <tr>
                <th className="border-r border-[var(--border-subtle)] px-4 py-3 font-medium">当前数量</th>
