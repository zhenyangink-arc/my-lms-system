...
export function QuestionSection() {
  return (
    <section id="start-plan" className="scroll-mt-24 bg-[#f8fbff] px-5 pb-20 sm:px-8 sm:pb-28">
      <div className="relative mx-auto max-w-7xl overflow-hidden rounded-[2.5rem] border border-[#cfe8f6] bg-gradient-to-br from-[#e9f4ff] via-[#f1f8ff] to-[#eaf9ef] px-6 py-12 shadow-[0_26px_70px_rgba(61,117,150,0.13)] sm:px-12 sm:py-16 lg:px-16">
        <div className="absolute -left-20 -top-20 h-60 w-60 rounded-full bg-[#ccecff]/70 blur-2xl" />
        <div className="absolute -bottom-24 -right-16 h-64 w-64 rounded-full bg-[#cadaff]/65 blur-2xl" />
        ...
        <div className="relative grid items-center gap-10 lg:grid-cols-[0.62fr_0.38fr]">
          <div>
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row">
              <Link
                href="#start-plan"
                className="group inline-flex items-center justify-center gap-2 rounded-2xl bg-[#5b97f3] px-7 py-4 text-base font-black text-white shadow-[0_16px_35px_rgba(91, 151, 243,0.25)] transition hover:-translate-y-1 hover:bg-[#4b88e4]"
              >
                免费建立成长档案
