...
export function CommonServices() {
  return (
    <section id="services" className="scroll-mt-24 bg-[#f8fbff] py-20 sm:py-28">
            ...
            {[
              ...
              return (
                <div key={label as string} className="flex items-center gap-3 rounded-2xl border border-[#e0edf3] bg-white p-4 text-sm font-black text-[#45667b] shadow-sm">
                  <PointIcon size={19} className="shrink-0 text-[#5e97f1]" />
                  {label as string}
                </div>
              );
            })}
            ...
            return (
              ...
              >
                <div className="flex items-start justify-between">
                  ...
                  <ArrowUpRight className="text-[#aac0cd] transition group-hover:translate-x-1 group-hover:-translate-y-1 group-hover:text-[#5b95f0]" />
                </div>
                ...
                <span className="mt-7 inline-flex text-sm font-black text-[#538ee9]">进入服务</span>
              </Link>
            );
          })}
        </div>
