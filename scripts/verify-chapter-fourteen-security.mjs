...
try {
  ...
  const weakWriting = await submitSmartTextbookActivityForContext({ activityId: writingActivity.id, locale: "zh-CN", response: { text: "가나다라 마바사. 아자차카 타파하. 자차카타 파하가. 나다라마 바사아. 차카타파 하가나. 다라마바 사아자.", informationKinds: Array(10).fill(true), rubricConfirmed: true } }, context);
