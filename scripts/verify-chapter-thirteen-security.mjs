...
try {
  ...
  const weakWriting = await invokeAction({ activityId: writingActivity.id, locale: "zh-CN", response: { text: "가나다라 마바사. 아자차카 타파하. 가나다라 마바사. 아자차카 타파하. 가나다라 마바사. 아자차카 타파하.", informationKinds: Array(7).fill(true), rubricConfirmed: true } });
