...
console.log("=== EXECUTING 202608070012 ===");
const sql = fs.readFileSync("supabase/migrations/202608070012_drop_session_student_not_null.sql", "utf8");
try {
...
try {
  const out = runQuery(
    "insert into supabase_migrations.schema_migrations (version, name, statements) values ('202608070012', 'drop_session_student_not_null', '{}') on conflict (version) do nothing;"
  );
