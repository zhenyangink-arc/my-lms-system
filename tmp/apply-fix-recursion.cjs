...
console.log("=== EXECUTING 202608070011 ===");
const sql = fs.readFileSync("supabase/migrations/202608070011_fix_live_class_rls_recursion.sql", "utf8");
try {
...
try {
  const out = runQuery(
    "insert into supabase_migrations.schema_migrations (version, name, statements) values ('202608070011', 'fix_live_class_rls_recursion', '{}') on conflict (version) do nothing;"
  );
